                ...
                {globalState?.ConstructionFData?.PropertyKind == 'Residential' ?
                    <View style={{ width: '100%', backgroundColor: '#FFFFFF', paddingHorizontal: 15, flex: 1, }}>
                        ...
                        <Text style={{
                            ...
                            color: '#000000',
                            marginTop: 20
                        }}>Pick the spaces for a interior makeover. *</Text>
                        <TouchableOpacity
                            onPress={() => {
                            ...
                            style={{ marginVertical: 20, borderRadius: 5, padding: 15, width: '100%', backgroundColor: DesignRooms.includes('Living Room') ? '#021265' : '#FFFFFF', borderWidth: 1, borderColor: '#DCDCDC' }}>
                            <Text style={{
                                fontSize: 12,
                                fontFamily: 'WorkSans-Medium',
                                color: DesignRooms.includes('Living Room') ? '#FFFFFF' : '#000000',
                                //  marginTop: 20
                            }}>Living Room</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            style={{ borderRadius: 5, padding: 15, width: '100%', backgroundColor: DesignRooms.includes('Kitchen') ? '#021265' : '#FFFFFF', borderWidth: 1, borderColor: '#DCDCDC' }}>
                            <Text style={{
                                fontSize: 12,
                                fontFamily: 'WorkSans-Medium',
                        ...
                        <TouchableOpacity
                            ...
                            style={{ marginVertical: 20, borderRadius: 5, padding: 15, width: '100%', backgroundColor: DesignRooms.includes('Bedroom') ? '#021265' : '#FFFFFF', borderWidth: 1, borderColor: '#DCDCDC' }}>
                            <Text style={{
                                fontSize: 12,
                                fontFamily: 'WorkSans-Medium',
                        ...
                        <TouchableOpacity
                            ...
                            style={{ borderRadius: 5, padding: 15, width: '100%', backgroundColor: DesignRooms.includes('Bathroom') ? '#021265' : '#FFFFFF', borderWidth: 1, borderColor: '#DCDCDC' }}>
                            <Text style={{
                                fontSize: 12,
                                fontFamily: 'WorkSans-Medium',
                        ...
                        <TouchableOpacity
                            ...
                            style={{ marginVertical: 20, borderRadius: 5, padding: 15, width: '100%', backgroundColor: DesignRooms.includes('Balcony') ? '#021265' : '#FFFFFF', borderWidth: 1, borderColor: '#DCDCDC' }}>
                            <Text style={{
                                fontSize: 12,
                                fontFamily: 'WorkSans-Medium',
                        ...
                        <TouchableOpacity
                            ...
                            style={{ borderRadius: 5, padding: 15, width: '100%', backgroundColor: DesignRooms.includes('Dining Area') ? '#021265' : '#FFFFFF', borderWidth: 1, borderColor: '#DCDCDC' }}>
                            <Text style={{
                                fontSize: 12,
                                fontFamily: 'WorkSans-Medium',
                                color: DesignRooms.includes('Dining Area') ? '#FFFFFF' : '#000000',
                                //  marginTop: 20
                            }}>Dining Area</Text>
                        </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{ marginHorizontal: 30, backgroundColor: '#021265', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 15, paddingVertical: 10, borderRadius: 5 }}
                                onPress={() => {
                                    if (DesignRooms.length == 0) {
                                        Alert.alert('Mandatory section required', 'Please select the rooms you’d like us to design.');

                                    } else {
                                        navigation.navigate('InteriorFormThird', { Data: { Form, DesignRooms: DesignRooms } });
                                    }
                                }}>
                            ...
                            <TouchableOpacity style={{ marginHorizontal: 30, backgroundColor: '#021265', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 15, paddingVertical: 10, borderRadius: 5 }}
                                onPress={() => {
                                    if (Adress == '' && Pin == '' && PropertySize == '') {
                                        ...
                                        Alert.alert('Area field empty ', 'Please enter the area of your property.');

                                    } else if (Adress == '') {
                                        Alert.alert('Location field empty ', 'Please field location section.');
                                    }
                                    else {
                                        navigation.navigate('InteriorFormThird', { Data: { Form, PropertySize: PropertySize, City: Location, Pincode: Pin, Adress: Adress, AdressSec: AdressSec } })
                                    }
                                }}>
                                <Text style={{ fontSize: 16, fontFamily: 'WorkSans-SemiBold', color: '#FFFFFF', }}>Next</Text>
                            </TouchableOpacity>
