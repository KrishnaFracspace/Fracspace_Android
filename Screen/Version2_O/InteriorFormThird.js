...
export default function InteriorFormThird(props) {
    ...
    const [Location, setLocation] = useState(globalState?.currentLocation?.City ? globalState?.currentLocation?.City : 'Hyderabad');
    const [Adress, setAdress] = useState('');
    const [AdressSec, setAdressSec] = useState(globalState?.currentLocation?.Address ? globalState?.currentLocation?.Address : '');
    const [Pin, setPin] = useState(globalState?.currentLocation?.Pincode ? globalState?.currentLocation?.Pincode : '');
    const CityData = [
    ...
    const handleInteriorListing = async () => {
        let payload = JSON.stringify({
            ...
            residentialType: P_Type == 'R' ? globalState?.ConstructionFData?.PropertyTypeR + globalState?.ConstructionFData?.ifOtherPropertyType : InteriorData?.Form?.Form1?.PropertyTypeC + globalState?.ConstructionFData?.ifOtherPropertyTypeC,
            propertyConfiguration: P_Type == 'R' ? InteriorData?.Form?.PropertyConfiguration : '',
            bhkSize: P_Type == 'R' ? InteriorData?.Form?.PropertySize : InteriorData?.PropertySize,
            location: P_Type == 'R' ? Location : InteriorData?.City,
            locationDetails: {
                longitude: 77.2195,
                latitude: 28.6315,
                place: "",
                address: P_Type == 'R' ? Adress + ' ' + AdressSec : InteriorData?.Adress + '' + InteriorData?.AdressSec,
        ...
        try {
            ...
            if (res?.success) {
                Alert.alert('Thank you for submitting your request!', 'Our concierge will get back to you within 24 hours.');
    ...
    const handleContructionListing = async () => {
        let payload = JSON.stringify({
            ...
            commercialType: P_Type == 'R' ? globalState?.ConstructionFData?.PropertyTypeR + globalState?.ConstructionFData?.ifOtherPropertyType : globalState?.ConstructionFData?.PropertyTypeC + globalState?.ConstructionFData?.ifOtherPropertyTypeC,
            ...
            <View style={{ width: '100%', backgroundColor: '#FFFFFF', paddingHorizontal: 15, flex: 1, }}>
                ...
                {P_Type == "C" ? <>
                    ...
                    <Text style={{
                        ...
                        color: '#000000'
                    }}>Choose your preference *</Text>

                    <View style={{ alignItems: 'center' }}>
                        <TouchableOpacity onPress={() => {
                            setPropertyPreference('Standard');
                        }}
                            style={{ borderWidth: PropertyPreference == 'Standard' ? 2 : 0, borderColor: '#021265', borderRadius: 12, alignItems: 'center', width: '100%', marginBottom: 5, marginTop: 20 }}>
                            <Image
                                //resizeMode="stretch"
                                resizeMode='contain'
                                style={{ width: width * 0.9, flex: 1, height: height * 0.15 }}
                                source={globalState?.userEvent == 'Construction' ? require('./assets/construction1.png') : require('./assets/Standard.png')}
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => {
                            setPropertyPreference('Premium');
                        }}
                            style={{ borderWidth: PropertyPreference == 'Premium' ? 2 : 0, borderColor: '#021265', borderRadius: 9, alignItems: 'center', width: '100%', marginTop: 13 }}>
                            <Image
                                //resizeMode="stretch"
                                resizeMode='contain'
                                style={{ width: width * 0.9, flex: 1, height: height * 0.15 }}
                                source={globalState?.userEvent == 'Construction' ? require('./assets/construction2.png') : require('./assets/Premium.png')}
                            />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => {
                            setPropertyPreference('Elite');
                        }}
                            style={{ borderWidth: PropertyPreference == 'Elite' ? 2 : 0, borderColor: '#021265', borderRadius: 9, alignItems: 'center', width: '100%', marginTop: 13 }}>
                            <Image
                                //resizeMode="stretch"
                                resizeMode='contain'
                                style={{ width: width * 0.9, flex: 1, height: height * 0.15 }}
                                source={globalState?.userEvent == 'Construction' ? require('./assets/construction3.png') : require('./assets/Elite.png')}
                            />
                        </TouchableOpacity>
                    </View>

                    {globalState?.userEvent != 'Construction' && <><Text style={{
                        fontSize: 14,
                        fontFamily: 'WorkSans-Medium',
                        color: '#000000',
                        paddingTop: 25,
                    ...
                    {globalState?.userEvent == 'Construction' && <><Text style={{
                        ...
                        paddingTop: 25,
                        paddingBottom: 25
                    }}>Do you require design assistance? * </Text>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    ...
                                    paddingVertical: 10,
                                    backgroundColor: Budget == 'Yes, I need help' ? '#021265' : '#FFFFFF',
                                    borderRadius: 20,
                                    alignItems: 'center',
                                    marginRight: 8
                                }}>
                                <Text style={{
                                    fontSize: 12,
                                    fontFamily: 'WorkSans-Medium',
                                    color: Budget == 'Yes, I need help' ? '#FFFFFF' : '#000000',
                                    opacity: Budget == 'Yes, I need help' ? 1 : 0.6,
                                }}>Yes, I need help</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={() => {
                                ...
                                style={{
                                    ...
                                    paddingHorizontal: 30,
                                    paddingVertical: 10,
                                    backgroundColor: Budget == 'No, I have designs' ? '#021265' : '#FFFFFF',
                                    borderRadius: 20,
                                    alignItems: 'center',
                                    marginRight: 8
                                }}>
                                <Text style={{
                                    fontSize: 12,
                                    fontFamily: 'WorkSans-Medium',
                                    color: Budget == 'No, I have designs' ? '#FFFFFF' : '#000000',
                                    opacity: Budget == 'No, I have designs' ? 1 : 0.6,
                                }}>No, I have designs</Text>
                            </TouchableOpacity>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <Image
                                    ...
                                    resizeMode='contain'
                                    style={{ width: width * 0.9, flex: 1, height: height * 0.15 }}
                                    source={globalState?.userEvent == 'Construction' ? require('./assets/construction6.png') : require('./assets/StandardR.png')}
                                />
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => {
                                setPropertyPreference('Premium');
                                ...
                                <Image
                                    ...
                                    resizeMode='contain'
                                    style={{ width: width * 0.9, flex: 1, height: height * 0.15 }}
                                    source={globalState?.userEvent == 'Construction' ? require('./assets/construction5.png') : require('./assets/PermiumR.png')}
                                />
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => {
                                setPropertyPreference('Elite');
                                ...
                                <Image
                                    ...
                                    resizeMode='contain'
                                    style={{ width: width * 0.9, flex: 1, height: height * 0.15 }}
                                    source={globalState?.userEvent == 'Construction' ? require('./assets/construction4.png') : require('./assets/EliteR.png')}
                                />
                            </TouchableOpacity>
                        </View>
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{ marginHorizontal: 30, backgroundColor: '#021265', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 15, paddingVertical: 10, borderRadius: 5 }}
                        ...
                        <Text style={{ fontSize: 16, fontFamily: 'WorkSans-SemiBold', color: '#FFFFFF', }}>Submit</Text>
                    </TouchableOpacity>
