// import { View, Text, ScrollView, Dimensions, Image, TouchableOpacity, Alert, Animated, StyleSheet, Modal } from 'react-native'
// import React, { useContext, useRef, useState } from 'react'
// import LinearGradient from 'react-native-linear-gradient'
// import Icon from 'react-native-vector-icons/Feather';
// import Ico from 'react-native-vector-icons/Ionicons';
// import DocumentPicker from 'react-native-document-picker';
// // import { Verification } from './PortfolioApi';
...
//         console.log("Uploaddoc: ",uploadedDocs);
...
//         {
//             key: 'cheque',
//             docName: 'Government Issued Photo ID',
//             uploadName: 'Government ID',
//             fileFormat: 'PDF / JPG / PNG',
//             size: '10 MB',
//             allowedTypes: ['application/pdf', 'image/jpeg', 'image/png'],
//             logo: "https://duixj37yn5405.cloudfront.net/appImages/Cheque.png",
...
//                     return (
//                         <View key={item.key} style={{ margin: 20 }}>
//                             <TouchableOpacity
//                                 disabled={!!uploadedFile}
//                                 onPress={() => pickDocument(item)}
//                                 style={{ borderWidth: 0.7, borderColor: '#000', borderRadius: 10, paddingHorizontal: 20,paddingVertical:10 }}
//                             >    
//                                 {/* Logo */}
...
//                                     <Image resizeMode='cover' source={{uri: uploadedFile?.uri}} style={{width:40,height:60}}/>
//                                 </View> */}
...
//                                             <View style={{}}>
//                                                 <Image resizeMode='cover' source={{uri: uploadedFile?.uri}} style={{width:60,height:40}}/>
//                                             </View>
//                                             :
        ...
        <SafeAreaView style={{ flex: 1 }}>
            {profile?.documents?.length === 0 && profile?.verification == false ?
                <ScrollView style={{ backgroundColor: '#FFF' }}>
                    ...
                    <TouchableOpacity disabled={isUploading} activeOpacity={0.8} onPress={() => {
                        UploadDoc();
                    }} style={{ backgroundColor: '#021265', padding: 10, borderRadius: 5, alignItems: 'center', marginHorizontal: 20, marginBottom: 140, }}>
