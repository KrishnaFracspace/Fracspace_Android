            ...
            <ScrollView style={{ backgroundColor: '#FFFFFA' }}>
                ...
                {props?.route?.params?.Blogfor == 'SrilankaBlog' && <View style={{ padding: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignContent: 'flex-end', justifyContent: 'space-between' }}>
                        <View>
                            <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/FsLogo.png' }} style={{ width: 70, height: 50 }} />
                        </View>
                    ...
                    <View style={{ marginVertical: 15 }}>
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/TitlePage.png' }} style={{ width: width * 0.9, height: 200 }} />
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', marginVertical: 20 }}>
                        ...
                        <Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 16, color: '#000000' }}>Columbo -
                            <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 16, color: '#000000' }}> The Pulse of the Island:</Text>
                        </Text>
                    </View>

                    <View>
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Columbo.png' }} style={{ width: width * 0.9, height: 200 }} />
                    </View>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/crab.png' }} style={{ width: 110, height: 80 }} />
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: 15 }}>
                            ...
                            <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/steak.png' }} style={{ width: 110, height: 80 }} />
                        </View>
                    ...
                    <View >
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Ahangama.png' }} style={{ width: width * 0.9, height: 200 }} />
                    </View>
                    ...
                    <View>
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Unawatuna.png' }} style={{ width: width * 0.9, height: 200 }} />
                    </View>
                    ...
                    <View>
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Mirissa.png' }} style={{ width: width * 0.9, height: 200 }} />
                    </View>
                ...
                {props?.route?.params?.Blogfor == 'VaranasiBlog' && <View style={{ padding: 20 }}>
                    ...
                    <View style={{ marginTop: 20, marginBottom: 10 }}>
                        <Image resizeMode='cover' source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Varanasi1.jpeg' }} style={{ width: width * 0.9, height: 210 }} />
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'space-between' }}>
                        ...
                        <View style={{ marginLeft: 5 }}>
                            <Image resizeMode='cover' source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Varanasi3.jpeg' }} style={{ width: 140, height: 180 }} />
                        </View>
                    </View>

                    <View style={{ marginTop: 15 }}>
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Varanasi2.jpg' }} style={{ width: width * 0.9, height: 210 }} />
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'space-between' }}>
                        ...
                        <View>
                            <Image resizeMode='cover' source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Varanasi4.jpg' }} style={{ width: 140, height: 220 }} />
                        </View>
                    </View>
                    ...
                    <View style={{ marginTop: 15 }}>
                        <Image source={{ uri: 'https://fracspace-updates.s3.ap-south-1.amazonaws.com/appImages/Varanasi5.jpg' }} style={{ width: width * 0.9, height: 210 }} />
                    </View>
...
//         <SafeAreaView style={{ flex: 1 }}>
//             <ScrollView style={{ backgroundColor: '#FFFFFA', }}>
//                 <View style={{ backgroundColor: '#1A1A1A', padding: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
//                     <Icon name={'chevron-left'} size={16} color={'#FFF'} />
//                     <Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 16, color: '#FFF' }}>Blogs</Text>
//                     <View></View>
//                 </View>
...
//                 <View style={{ borderTopColor: '#62626240', borderTopWidth: 1, marginHorizontal: 20, marginTop: 10 }} />
