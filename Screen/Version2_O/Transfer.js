...
//     useEffect(() => {
//         const filteredNumbers = globalState?.ProDetails.filter(number => number.H_property == true);
//         setRecommended(filteredNumbers);
//     }, []);
...
//                             <View style={{ marginVertical: 10 }}>
//                                 <Text style={{ fontFamily: 'Montserrat-SemiBold', fontSize: 12, color: '#00000080' }}>Your transfer request has been received. Your fractional shares will be processed, and the transfer will be completed once the request is successfully processed.</Text>
//                             </View>
//                             <TouchableOpacity onPress={() => {
//                                 setNotSelected(!notselected);
...
import { View, Text, Image, Dimensions,ActivityIndicator, TouchableOpacity, TextInput, ScrollView, Alert, Modal } from 'react-native'
import React, { useContext, useEffect, useRef, useState } from 'react'
import Icon from 'react-native-vector-icons/Entypo';
import Icon1 from 'react-native-vector-icons/AntDesign';
import LinearGradient from 'react-native-linear-gradient';
import CustomModal from '../CustomModal';
import { useNavigation } from '@react-navigation/native';
import { ProfileDetails, PropertyDetails, SendConfirmationOTPEmail, TransferProperty, TransferPropertyOTP, TransferPropertyOTPVerify, VerifyOtpAndStoreMessageEmail } from '../Services/UserApi';
import { AppContext } from '../Context/AppContext';
import { SafeAreaView } from 'react-native-safe-area-context';
