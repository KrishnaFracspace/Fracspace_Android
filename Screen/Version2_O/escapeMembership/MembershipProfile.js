...
export default function MembershipProfile(props) {
    ...
    // console.log("agreement URL:", activeInvestment?.agreementUrl);
                ...
                <ScrollView style={{}}>
                                    ...
                                    <View>
                                        ...
                                        <View style={{flexDirection:'row',alignItems:'center',gap:10}}>
                                            ...
                                            <TouchableOpacity onPress={() => {
                                                ...
                                                {
                                                    visible ?
                                                    <Icon name={'eye-outline'} size={18} color={'#AC935C'}/>
                                                    :
                                                    <Icon name={'eye-off-outline'} size={18} color={'#AC935C'}/>   
                                                }
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                    ...
                    <View style={{marginTop:15,marginHorizontal:20}}>
                        ...
                        <TouchableOpacity onPress={() => {navigation.navigate('TranHisForEscape', {data: investmentDetails})}} style={{backgroundColor:'#f6f6f6',borderRadius:10,padding:15,marginTop:12,elevation:3}}>
                            ...
                            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                                <View style={{gap:5}}>
                                    <Text style={{fontFamily:'WorkSans-Medium',fontSize:12,color:'#000'}}>{investmentDetails[0]?.investmentPlan?.name || 'Escape Membership'}</Text>
                                    <Text style={{fontFamily:'WorkSans-Regular',fontSize:10,color:'#00000080'}}>{investmentDetails[0]?.paymentProof?.paymentMethod || 'Payment Method'}</Text>
                                </View>
                                <View style={{gap:5}}>
                                    ...
                                    <TouchableWithoutFeedback>
                                        <View style={{backgroundColor:'#F6F6F6',borderRadius:12,padding:20,width:width*0.9}}>
                                            ...
                                            <View style={{marginTop:15}}>
                                                ...
                                                <View style={{borderWidth:0.5,borderRadius:5,borderColor:'#000',marginTop:10}}>
                                                    <TextInput
                                                        placeholder='John Doe'
                                                        placeholderTextColor={'#00000080'}
                                                        value={holderName}
                                                        onChangeText={setHolderName}
                                                        style={{fontFamily:'WorkSans-Medium',fontSize:12,color:'#000',marginLeft:10}}
                                                    />
                                                </View>
                                            </View>
