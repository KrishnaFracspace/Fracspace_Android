...
export default function PaidSuccessfully(props) {
  ...
  return (
    <SafeAreaView style={{flex:1,backgroundColor:'#C7E5FD'}}>
        <ScrollView style={{flex:1,backgroundColor:'#FFFFFF',width:'100%'}}>
            <LinearGradient colors={['#C7E5FD','#FFFFFF']} style={{}}>
                ...
                <View style={{backgroundColor:'#FFFFFF',borderColor:'#62626233',borderWidth:1,padding:20,borderRadius:18,margin:20}}>
                    ...
                    <View style={{flexDirection:'row',marginHorizontal:10,}}>
                        <View style={{borderLeftWidth:1,borderLeftColor:'#000000',borderStyle:'dashed',marginVertical:20}}>
