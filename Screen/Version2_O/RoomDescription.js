    ...
    return (
        <SafeAreaView style={{ flex: 1,  backgroundColor: '#0D2038'}}>
            <ScrollView style={{ backgroundColor: '#FAFAFF', width: '100%' }}>
                <View style={{ backgroundColor: '#0E2037', padding: 20 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 16, color: '#FFFFFF' }}>{description?.name}</Text>
                ...
                <View style={{ paddingHorizontal: 20, paddingVertical: 15 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 14, color: '#000000' }}>Popular Amenities</Text>
                        {/* <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 10, color: '#0424CB', textDecorationLine: 'underline' }}>VIEW ALL</Text> */}
                    </View>
                    ...
                    <ScrollView horizontal={true} style={{ marginTop: 15, gap: 15 }}>
                        {description?.majorAmenities?.includes("Free WiFi") &&
                            <View style={{ borderColor: '#62626233', borderWidth: 1, marginHorizontal: 5, backgroundColor: '#FFFFFF', borderRadius: 15, padding: 20, alignItems: 'center', justifyContent: 'center', }}>
                                ...
                                <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 10, color: '#101010', marginTop: 5 }}>Wifi</Text>
                            </View>
                        }
                        ...
                        {description?.majorAmenities?.includes('Free Parking') &&
                            <View style={{ borderColor: '#62626233', borderWidth: 1, marginHorizontal: 5, backgroundColor: '#FFFFFF', borderRadius: 15, padding: 20, alignItems: 'center', justifyContent: 'center' }}>
                                ...
                                <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 10, color: '#101010', marginTop: 5 }}>Parking</Text>
                            </View>
                        }
                    ...
                    {visible1 == "Transport" &&
                        <View style={{ marginTop: 15, gap: 10 }}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 12, color: '#000000', marginLeft: 10 }}>{description?.sightseeing?.Transport[1]?.name}</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Ic name={'train-outline'} size={20} color={'#000000'} />
                                <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 12, color: '#000000', marginLeft: 10 }}>{description?.sightseeing?.Transport[2]?.name}</Text>
                            </View>
                        </View>
                    }
                </View>
                ...
                <View style={{ paddingHorizontal: 20, paddingVertical: 15 }}>
                    <TouchableOpacity onPress={() => {
                        ...
                        <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 14, color: '#000000', textDecorationLine: 'underline' }}>Hotel Rules & Policies</Text>
                        {rules ?
                            <Icco name={'chevron-down'} size={15} color={'#333333'} style={{ marginLeft: 10 }} /> :
                            <Icco name={'chevron-up'} size={15} color={'#333333'} style={{ marginLeft: 10 }} />}
                    </TouchableOpacity>

                    {!rules &&
                        <>
                            <View style={{ marginTop: 20 }}>
                                <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 12, color: '#1A1A1A' }}>Check-in Check-out</Text>
                                <View style={{ marginVertical: 10 }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        <Ico name={'clock'} size={18} color={'#333333'} />
                                        <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: '#000000', marginLeft: 10 }}>{description?.checkInTime}</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10 }}>
                                        <Ico name={'clock'} size={18} color={'#333333'} />
                                        <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: '#000000', marginLeft: 10 }}>{description?.checkOutTime}</Text>
                                    </View>
                                    {/* <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            {/* <View style={{ marginTop: 10 }}>
                                ...
                                <View style={{ marginVertical: 10 }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        <Iconn name={'paw-off-outline'} size={20} color={'#333333'} />
                                        <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: '#000000', marginLeft: 10 }}>No pets</Text>
                                    </View>
                ...
                <View style={{ paddingHorizontal: 20, paddingVertical: 5 }}>
                    <TouchableOpacity onPress={() => {
                        ...
                        <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 14, color: '#000000', textDecorationLine: 'underline' }}>Cancellation policy</Text>
                        {policy ?
                            <Icco name={'chevron-down'} size={15} color={'#333333'} style={{ marginLeft: 10 }} /> :
                            <Icco name={'chevron-up'} size={15} color={'#333333'} style={{ marginLeft: 10 }} />
                        }
                    ...
                    {!policy &&
                        <View>
                            <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 12, color: '#000000', marginVertical: 10 }}>
                                Add a touch of elegance to your lifestyle with our Premium {description?.name}. This stylish property effortlessly
                                blends modern architecture with the beauty of nature, making it a versatile haven for luxury living More..
                            </Text>
                            <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 12, color: '#000000' }}>Full refund:
                                <Text style={{ fontFamily: 'WorkSans-Regular', fontSize: 12, color: '#000000' }}> {description?.policies?.cancellationPolicy}</Text>
                            </Text>
                            <View style={{ borderWidth: 1, borderColor: '#F0EFFB', marginVertical: 7 }}></View>
                            <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 12, color: '#000000' }}>Pet Policy:
                                <Text style={{ fontFamily: 'WorkSans-Regular', fontSize: 12, color: '#000000' }}> {description?.policies?.petPolicy}</Text>
                            </Text>
                            <View style={{ borderWidth: 1, borderColor: '#F0EFFB', marginVertical: 7 }}></View>
                            <Text style={{ fontFamily: 'WorkSans-Medium', fontSize: 12, color: '#000000' }}>Other Policy:
                                <Text style={{ fontFamily: 'WorkSans-Regular', fontSize: 12, color: '#000000' }}> {description?.policies?.otherPolicies}</Text>
                            </Text>
                            <View style={{ borderWidth: 1, borderColor: '#F0EFFB', marginVertical: 7 }}></View>
                        </View>
                    }
            ...
            <View style={{ backgroundColor: '#FFFFFF', padding: 20, flexDirection: 'row', elevation: 5 }}>
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 21, color: '#101010' }}>₹{RoomType?.price}/N</Text>
                    <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 14, color: '#0D2037' }}>+ taxes & fees</Text>
                </View>
                <TouchableOpacity onPress={() => {
