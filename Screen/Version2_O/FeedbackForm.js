  ...
  export default function FeedbackForm() {
    ...
    const handleFeedback = async () => {
      let payload = JSON.stringify({
        ...
        associationDuration: question1, 
        assistedBy: question2,
        onboardingRating: rating, 
        investmentSmoothness: question6, 
        documentationClarity: question7,
        investedProperties: question3, 
        propertySatisfaction: value, 
        receivedBROI: question8, 
        postInvestmentSupport: assistanceRating,
        wellInformed: question10, 
        teamResponsiveness: question11, 
        likesAboutFracspace: question12,
        improvementAreas: question13,
        recommendToOthers: question14, 
        investAgain: question15, 
        additionalFeedback: '',
      });
