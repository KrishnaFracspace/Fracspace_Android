import { View, Text, TouchableOpacity, StyleSheet, TextInput, Alert, Modal, Image, Dimensions, ScrollView } from 'react-native';
                ...
                <View
                    ...
                    <TouchableOpacity
                        ...
                        <View style={styles.option}>
                            <View style={[styles.checkbox, { backgroundColor: Terms == true ? '#0E2038' : '#FFFFFF', borderWidth: 1, borderColor: '#566B77' }]}>
                                {Terms && (
