      ...
      <View style={styles.footerStyle}>
        {activeTab == 'home' ? (
          <TouchableOpacity
            ...
            <Text style={{ color: '#021265', fontSize: 10, fontFamily: "OpenSans-ExtraBold" }}>
              Home
            </Text>
          </TouchableOpacity>
        ) : (
          <TouchableOpacity
            ...
            <Text style={{ color: '#808080', fontSize: 10, fontFamily: "OpenSans-ExtraBold" }}>
              Home
            </Text>
          </TouchableOpacity>
        )}
        ...
        {activeTab == 'like' ? (
          ...
          <TouchableOpacity
            ...
            <Icon name="heart" size={25} color='#808080' />
            <Text style={{ color: '#808080', fontSize: 10, fontFamily: "OpenSans-ExtraBold" }}>
              Like
            </Text>
          </TouchableOpacity>
        ...
        {activeTab == 'owned' ? (
          ...
          <TouchableOpacity
            ...
            <Pro name="profile" size={25} color='#808080' />
            <Text style={{ color: '#808080', fontSize: 10, fontFamily: "OpenSans-ExtraBold" }}>
              Owned
            </Text>
          </TouchableOpacity>
