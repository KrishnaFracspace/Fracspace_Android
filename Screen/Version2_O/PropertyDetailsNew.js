...
import { CallRecordBuyAndRent, ChangePropertySoldOutStatus } from '../Services/UserApi';
...
export default function PropertyDetailsNew(props) {
  ...
  const handleSoldandRentOut = async (PropId) => {
    let payload = JSON.stringify({
      propertyId: PropId,
    });
    ...
    try {
      let { data: res } = await ChangePropertySoldOutStatus(payload);
      //  console.log(res?.data[0]?.images[0]);

       

      if (res?.success) {
        Alert.alert('Your property status has been updated!');
  ...
  return (
    ...
    <ScrollView style={{ color: '#FAFAFF', width: '100%' }}>
     ...
     {PropertiesArray?.amenities.length!=0 && <View style={{ paddingHorizontal: 20 }}>
        ...
        <ScrollView horizontal={true}>
          <View style={{ flexDirection: 'row' }}>
            {PropertiesArray?.amenities.includes('Wifi') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <Icon name={'wifi'} size={30} color={'#101010'} />
            ...
            {PropertiesArray?.amenities.includes('Spa') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconM name={'spa'} size={30} color={'#101010'} />
            ...
            {PropertiesArray?.amenities.includes('Clubhouse') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconM name={'hoop-house'} size={30} color={'#101010'} />
            ...
            {PropertiesArray?.amenities.includes('Pool') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconM name={'pool'} size={30} color={'#101010'} />
            ...
            {PropertiesArray?.amenities.includes('Fitness Center') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconMa name={'fitness-center'} size={30} color={'#101010'} />
              <Text style={{ color: '#101010', fontFamily: 'Montserrat-Medium', fontSize: 10 }}>Fitness Center</Text>
            </View>}
            {PropertiesArray?.amenities.includes('Elavator') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconFo name={'elevator'} size={30} color={'#101010'} />
              <Text style={{ color: '#101010', fontFamily: 'Montserrat-Medium', fontSize: 10 }}>Elavator</Text>
            </View>}
            {PropertiesArray?.amenities.includes('Car Parking') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconMa name={'directions-car-filled'} size={30} color={'#101010'} />
              <Text style={{ color: '#101010', fontFamily: 'Montserrat-Medium', fontSize: 10 }}>Car Parking</Text>
            </View>}
            {PropertiesArray?.amenities.includes('Other') && <View style={{ marginRight: 20, borderRadius: 20, borderColor: '#DCDCDC', borderWidth: 1, alignItems: 'center', padding: 20, alignItems: 'center', justifyContent: 'center' }}>
              <IconM name={'dots-horizontal-circle-outline'} size={30} color={'#101010'} />
              <Text style={{ color: '#101010', fontFamily: 'Montserrat-Medium', fontSize: 10 }}>Other</Text>
            </View>}
          </View>
        </ScrollView>
      </View>}
        ...
        <View
          ...
          {PropertiesArray?.builtUpArea != '' && <View
            ...
            <Text
              ...
              {PropertiesArray?.totalArea}  sq ft
            </Text>
          </View>}
          {PropertiesArray?.builtUpArea != '' && <View
            style={{
            ...
            <Text
              ...
              {PropertiesArray?.builtUpArea}  sq ft
            </Text>
          </View>}
          {PropertiesArray?.plotArea != '' && <View
            ...
            <Text
              ...
              {PropertiesArray?.plotArea}  sq ft
            </Text>
          </View>}
          {PropertiesArray?.carpetArea != '' && <View
            ...
            <Text
              ...
              {PropertiesArray?.carpetArea}  sq ft
            </Text>
          </View>}
          ...
          {PropertiesArray?.furnishingDetails!=0 &&<View
            style={{
              flexDirection: 'row',
              justifyContent: 'space-between',
              paddingVertical: 10,
      ...
      <View style={{ padding: 20 }}>
        <TouchableOpacity
          disabled={PropertiesArray?.soldOut}
          onPress={() => {
            if(PropertiesArray?.sellerEmail == globalState?.userEmail){
              handleSoldandRentOut(PropertiesArray?._id);
          ...
          style={{
            ...
            padding: 20,
            borderColor:PropertiesArray?.sellerEmail == globalState?.userEmail ?'#ff0000': '#021265',
            borderWidth: 1,
            borderRadius: 10,
            width: '100%',
            //marginBottom:50,
          ...
          {PropertiesArray?.sellerEmail == globalState?.userEmail ? <Text style={{ fontSize: 16, fontFamily: "Montserrat-Bold", color: '#ff0000' }}>
          {`${PropertiesArray?.listingType=='Sell'? 'Sold Out':'Rent Out'}`}
          </Text> : <>
