import { View, Text, ScrollView, StatusBar, Dimensions, StyleSheet, TouchableOpacity, Animated, Image, ImageBackground, TextInput } from 'react-native'
...
export default function RoomListing(props) {
    ...
    const [checkInDate, setCheckInDate] = useState(props?.route?.params?.checkInDate);
    const [checkOutDate, setCheckOutDate] = useState(props?.route?.params?.checkOutDate);
    ...
    const amenities = [
        "Wifi", "AC", "TV", "Mini Fridge", "Coffee Maker/Kettle", "Iron & Ironing Board", "Hair Dryer"
    ]
       ...
       <SafeAreaView style={{ flex: 1,  backgroundColor:"#0D2038"}}>
            ...
            <ScrollView style={{backgroundColor:'#FFFFFF'}}>
                ...
                {/* <View style={{ marginHorizontal: 20, borderRadius: 15, marginTop: -height * 0.14, backgroundColor: '#FFFFFF', elevation: 5, marginBottom: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', paddingHorizontal: 15, marginTop: 5, }}>
                        <View style={{ flex: 1 }}>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: '#0D1E36', marginLeft: 10 }}>
                        ...
                        <View style={{ flex: 1, marginLeft: 20 }}>
                            ...
                            }} style={{ borderWidth: 1, borderColor: '#62626233', padding: 10, borderRadius: 25, flexDirection: 'row', alignItems: 'center', flex: 1, marginTop: 5 }}>
                    ...
                    <View style={{ borderTopWidth: 1, borderTopColor: '#F0EFFB', marginVertical: 15 }}></View>
                        ...
                        return (
                            <TouchableOpacity onPress={() => {
                                ...
                                <View>
                                    ...
                                    <View style={{ position: "absolute", top: 15, right: 15 }}>
                                        <TouchableOpacity onPress={() => {
                                            ...
                                            <LinearGradient
                                                colors={like.includes(itemName) ? ["#FFFFFF", "#FFFFFF"] : ["#0000006B", "#9999996B"]}
                                                style={{
                                                    width: 40,
                                                    height: 40,
                                                    borderRadius: 40,
                                            ...
                                            >
                                                <Animated.View style={{ transform: [{ scale: scaleAnimations[itemName] }] }}>
                                ...
                                <View style={{ padding: 10, flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <View style={{ flex: 1 }}>
                                        <View style={{}}>
                                            <Text style={{ fontFamily: 'Montserrat-SemiBold', fontSize: 17, color: '#000000' }}>{item?.name}</Text>
                                        ...
                                        <View style={{ flexDirection: 'row', }}>
                                            ...
                                            <Text style={{ fontFamily: 'Montserrat-Regular', fontSize: 12, color: '#262D3D', marginLeft: 5 }}>{`${item?.location?.address}, ${item?.location?.city}`}</Text>
                                        </View>
                                    </View>
...

            {
                ...
                <CustomModal visible={true} modalStyle={{ width: '100%' }}>
                    <ScrollView style={{ backgroundColor: '#FFFFFF', borderTopLeftRadius: 40, borderTopRightRadius: 40, padding: 30 }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            setGuestModal(!guestModal);
                        }} style={{ backgroundColor: '#0D2038', borderRadius: 30, padding: 10, alignItems: 'center', marginHorizontal: 60, marginVertical: 20 }}>
...

            {
                showCalendar &&
                <CustomModal visible={true} modalStyle={{ width: '100%' }}>
                    <View style={{ backgroundColor: '#FFFFFF', padding: 30, borderWidth: 1, borderTopLeftRadius: 30, borderTopRightRadius: 30 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <View></View>
                            <Text style={{ fontFamily: 'Montserrat-SemiBold', fontSize: 17, color: '#000000' }}>Select Date</Text>
                            <TouchableOpacity onPress={() => {
                                setShowCalendar(!showCalendar);
                            }}>
...

            {
                ...
                <CustomModal visible={true} modalStyle={{ width: width, flex: 1 }}>
                    <ScrollView style={styles.container} contentContainerStyle={{ flexGrow: 1 }}>
                        ...
                        <View style={{ borderTopWidth: 1, borderTopColor: '#E7E9EB', marginVertical: 15 }}></View>

                        <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 16, color: '#000000' }}>Select Price Range:</Text>
                        {/*  */}
                        ...
                        <View style={{ paddingHorizontal: 10 }}>
                            <MultiSlider
                                ...
                                customMarker={(e) => (
                                    <View style={{ width: 20, height: 20, backgroundColor: '#0424CB', borderRadius: 10 }}></View>
                                )}
                            />
                        </View>

                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', borderColor: '#EAEAEA', borderWidth: 1, paddingHorizontal: 10, borderRadius: 6 }}>
                                <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 11, color: '#101010' }}>Min</Text>
                                <TextInput value={`₹${priceRange[0]}`} editable={false} style={{ marginLeft: 10, color: '#101010' }} />
                            </View>
                            <View style={{ flexDirection: 'row', alignItems: 'center', borderColor: '#EAEAEA', borderWidth: 1, paddingHorizontal: 10, borderRadius: 6 }}>
                                <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 11, color: '#101010' }}>Max</Text>
                                <TextInput value={`₹${priceRange[1]}`} editable={false} style={{ marginLeft: 10, color: '#101010' }} />
                            </View>
                        </View>
                            ...
                            <View style={{ flexDirection: 'row', gap: 15, flexWrap: 'wrap', marginTop: 10 }}>
                                {propertyTypes?.map((item, index) => (
                                    <TouchableOpacity key={index} onPress={() => {
                                        ...
                                        <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: propertyType == item ? '#FFFFFF' : '#00000099' }}>{item}</Text>
                                    </TouchableOpacity>
                                ))
                                }
                            </View>

                            <View style={{ borderTopColor: '#F0EFFB', borderTopWidth: 1, marginVertical: 15 }}></View>
                        </View>
                        ...
                        <View style={{}}>
                            ...
                            <View style={{ flexDirection: 'row', gap: 15, flexWrap: 'wrap', marginTop: 10 }}>
                                {roomTypes?.map((item, index) => (<TouchableOpacity key={index} onPress={() => {
                                    ...
                                    <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: roomType == item ? '#FFFFFF' : '#00000099' }}>{item}</Text>
                                </TouchableOpacity>))}
                            </View>

                            <View style={{ borderTopColor: '#F0EFFB', borderTopWidth: 1, marginTop: 15 }}></View>
                        </View>
                        ...
                        <View style={{borderTopColor:'#F0EFFB',borderTopWidth:1,marginVertical:10}}></View>
                    </View> */}

                        <View style={{ margin: 20, paddingBottom: 20 }}>
                            <TouchableOpacity onPress={() => {
                                setFilter(!filter);
                            }} style={{ backgroundColor: '#0E2037', padding: 15, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }}>
                                <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 14, color: '#FFFFFF' }}>Continue</Text>
                            </TouchableOpacity>
                        </View>
...

            {
                sort &&
                <CustomModal visible={true} modalStyle={{ width: '100%' }}>
                    <View style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 30 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <View>
                            <TouchableOpacity onPress={() => {
                                ...
                                {sortBy == "Popularity" ?
                                    <Ico name={'radio-button-on-outline'} size={20} color={'#001DD8'} /> :
                                    <Ico name={'radio-button-off-outline'} size={20} color={'#9B9B9B'} />
                                }
                                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 14, color: '#000000', marginLeft: 10 }}>Popularity</Text>
                            </TouchableOpacity>
                            ...
                            {/* <TouchableOpacity onPress={() => {
                            setSortBy("Lowest Price & High Ratings")
                        }} style={{flexDirection:'row', marginVertical:15}}>
                            {sortBy == "Lowest Price & High Ratings" ? 
                                <Ico name={'radio-button-on-outline'} size={20} color={'#001DD8'}/>:
                                <Ico name={'radio-button-off-outline'} size={20} color={'#9B9B9B'}/>
                            }
                            <Text style={{fontFamily:'Montserrat-Medium',fontSize:14,color:'#000000',marginLeft:10}}>Lowest Price & High Ratings</Text>
                        </TouchableOpacity> */}
                        </View>
