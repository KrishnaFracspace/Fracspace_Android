...
export default function NotificationsScreen(props) {
    ...
    const deleteNotification = async(notificationId) => {
        ...
        try{
            ...
            console.log("Error in deleting notification: ", error?.response?.data || error?.response?.message);
        }
    }
                                                        ...
                                                        <View style={{flex:1, justifyContent: 'space-between', alignItems: 'flex-end', flexDirection:'row' }}>
                                                            ...
                                                            {item?.buttonText &&
                                                                <TouchableOpacity
                                                                    ...
                                                                    style={{ backgroundColor: '#0424CB', borderColor: '#0421B4', borderWidth: 1, padding: 10, borderRadius: 10, width: 80,alignItems:'center' }}
                                                                >
