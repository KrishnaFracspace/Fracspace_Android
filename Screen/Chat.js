  ...
  const ChatArray = [
    {
      ...
      answer:
        "It's a form of shared ownership where multiple parties purchase shares of an entity under which the property is registered.",
    },
    {
      question: 'How does it differ from timeshare?',
      answer:
        'Fractional ownership is actual part ownership, whereas timeshare is more like a rental agreement.',
    },
    {
      question: 'Can I sell my fractional ownership share?',
      answer:
        'Yes, since the fractional value is of lower ticket sizes,you can sell your fraction anytime at the current market value with Fracspace, Note: we take a maximum tenure of 90 days to sell your fraction.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Our Domestic Holiday Home Fracs are Fixed at INR 10,00,000 per frac and International Fracs are priced at INR 25,00,000 per frac',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Fracspace takes ownership to maintain and manage the properties, we charge a nominal service fee of 15% on the gross total of its earnings before its paid out to its fractional owners.',
    },
    {
      question: 'Do I as a Fractional Owner get to stay at the property?',
      answer:
        'Yes, every fractional owner is entitled to stay at their invested property for 7 days, subject to pre-booking and availability. In addition to this you may receive promos to complimentary stays at other Fracspace Properties',
    },
    {
      question: 'How and when are yields paid out?',
      answer:
        'Currently all pay outs are processed after every quarter. We aim to issue quicker pay outs in the near future.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'These are asset backed investments, you are secured by the asset.',
    },
    {
      question:
        'How is fractional ownership better than traditional real-estate?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Fracspace holds subsidary entities / branch offices for every asset purchased and managed in the respective regions, the subsidary holds ownership of the asset.',
    },
    {
      question: 'Some Countries offer leasehold ownership.Explain this?',
      answer:
        ' Some countries offer long leaseholds ranging from 25 years upto 99 years. Fracspace holds leasehold ownerships for 5+7 years, or may extend depending on the demand, An advantage here, your lease amount is returned with nominal deductions, until this ownership is owned.',
    },
    {
      question:
        'Are you double taxed in the country of origin and country of Investment?',
      answer:
        'Fracspace handles and manages all the earnings generated from the invested property and abides to local laws and taxes, before being transferred to our source account for re-initiating local payouts to frac owners.International taxes and legalities will be handled by Fracspace',
    },
    {
    ...
    },
    {
      ...
      answer:
        ' Simply Upload a copy of your PAN, Aadhar and a Photo on the Fracspace App or send us an email with the above attachments.',
    },
    {
      question: 'What Documents will Fracspace provide its Frac Owners?',
      answer:
        'You will receive a Shareholder Agreement and a copy of the Sale Deed once complete.',
    },
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#021265' }}>
      ...
      <ScrollView ref={scrollViewRef}
        style={{ flex: 1, width: '100%', backgroundColor: '#FAFAFF', }}>
        <View
          style={{
        ...
        <View
          ...
          <View
            ...
            <Text style={{ color: '#1E2135', fontSize: 16, fontFamily: "Montserrat-Medium", }}>
        ...
        <View
          style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20, padding: 10, }}>
          <View
            style={{
              flex: 3,
              justifyContent: 'flex-start',
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Icon name={'angle-down'} size={30} color={'#043862'} />
              </TouchableOpacity>
            </View>
          </View>
