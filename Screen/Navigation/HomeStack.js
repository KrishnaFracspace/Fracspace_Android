...
export default function HomeStack() {
  return (
    <Stack.Navigator initialRouteName='HomePage' screenOptions={{ headerShown: false }}>
        ...
        {/* ------ Altaira ----- */}
        <Stack.Screen name="IntroAnim" component={IntroAnim}/>
        <Stack.Screen name="LabelsDescription" component={LabelsDescription}/>
        ...
        {/* <Stack.Screen name="EnquirtyFS" component={EnquirtyFS}/>S */}
